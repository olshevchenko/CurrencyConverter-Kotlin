...
* Repository pattern
* MVPVM Android Architecture
* Async w. RxJava
* Architecture Components (ViewModel, LiveData, Navigation, etc.)
* Wide coverage of tests (JUnit, Mockito, MockK, Koin, ...)

# License

   Copyright 2020-2021 Oleg I. Shevchenko 
   https://github.com/olshevchenko/CurrencyConverter-Kotlin
